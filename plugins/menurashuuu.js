...
const lakahutto = await conn.sendMessage(
  from,
  {
  ...
  { quoted: message }
        ...
        conn.ev.on('messages.upsert', async (msgUpdate) => {
            ...
            if (msg.message.extendedTextMessage.contextInfo && msg.message.extendedTextMessage.contextInfo.stanzaId === lakahutto.key.id) {
